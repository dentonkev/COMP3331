...
- Sockets acts as a mailing address, indicating where and how to send traffic across a network, 
- Port numbers represents one identifying element within that specific address.
...
- Fairly poor PLT
- Multiple TCP connections setups to the
same server

<img src="./images/rtt.png" width="400" height="auto">
...
**Time = N(2RTT + file transmission time)**
